...
const LoadingTableRow = withFullWidthTableRow(LoadingSpinner);
const ErrorTableRow = withFullWidthTableRow(ErrorRetry);
const EmptyTableRow = withFullWidthTableRow(EmptyData);
