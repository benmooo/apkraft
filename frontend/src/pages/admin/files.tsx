...
const mockApkFiles: ApkFile[] = [
  {
    ...
    path: "/uploads/files/apkraft-manager-v1.0.0.apk",
  ...
  },
  {
    ...
    path: "/uploads/files/apkraft-dashboard-v0.5.0.apk",
  ...
  },
  {
    ...
    path: "/uploads/files/apkraft-manager-v1.0.1.apk",
  ...
  },
  {
    ...
    path: "/uploads/files/apkraft-mobile-v2.0.0.apk",
  ...
  },
  {
    ...
    path: "/uploads/files/apkraft-dashboard-v0.6.0.apk",
...
export default function ApkFilesPage() {
  ...
  const [copiedChecksum, setCopiedChecksum] = React.useState<number | null>(
    null,
  );
  ...
  const paginatedApkFiles = filteredApkFiles.slice(
    startIndex,
    startIndex + pageSize,
  );
                    ...
                    <TableCell>
                      <div className="flex items-center gap-2">
                        ...
                        <Button
                          ...
                          className="h-6 w-6"
                          onClick={() =>
                            copyToClipboard(file.id, file.checksum_sha256)
                          }
                        >
      ...
      {totalPages > 1 && (
        <div className="flex items-center justify-between space-x-2 py-4">
          <div className="text-sm text-muted-foreground">
            ...
            {Math.min(startIndex + pageSize, filteredApkFiles.length)} of{" "}
            {filteredApkFiles.length} files
          </div>
